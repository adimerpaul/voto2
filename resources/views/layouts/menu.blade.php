...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="bower_components/font-awesome/css/font-awesome.min.css" defer>
    <!-- Ionicons -->
    <link rel="stylesheet" href="bower_components/Ionicons/css/ionicons.min.css" defer>
    <!-- DataTables -->
    <link rel="stylesheet" href="bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css" defer>
    <!-- Theme style -->
    <link rel="stylesheet" href="dist/css/AdminLTE.min.css" defer>
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css" defer>
...
<div id="app" class="wrapper" >
    <header class="main-header">
        ...
        <a href="{{ url('/home') }}" class="logo">
            ...
            <span class="logo-mini"><b>Tu</b> VOTO</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Tu</b> VOTO</span>
        </a>
...
{{--                </a>--}}
                ...
                <li class="treeview ">
                    <a href="#">
                        <i class="fa fa-table"></i> <span>Cabinas de votacion</span>
                    </a>
                </li>
                {{--                <li>--}}
...
<!-- SlimScroll -->
<script src="../../bower_components/jquery-slimscroll/jquery.slimscroll.min.js" defer></script>
<!-- FastClick -->
<script src="../../bower_components/fastclick/lib/fastclick.js" defer></script>
<!-- AdminLTE App -->
